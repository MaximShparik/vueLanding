<template>
	...
	<section class="py-16">
		...
		<div class="content">
			<div class="contentItem vote">
				<div class="voteText">
					We wanna spread the word, so I created Urban dictionary
					definition, please vote. Simply press like on the site
				</div>
				<div class="voteBtns">
					<div class="hands">
		...
		<!-- <img id="flying-image" src="@/assets/girl.jpeg" alt="Flying Image" /> -->
